...
description: 理解 BERT 和 GPT 在训练目标、能力侧重和应用方式上的差异。
tags: [NLP 与 Transformer, Transformer 原理, LLM学习地图]
category: NLP 与 Transformer
lang: zh_CN
draft: false
prevTitle: Encoder / Decoder
prevSlug: encoder-decoder
nextTitle: SFT 指令微调
nextSlug: sft-instruction-tuning
---
